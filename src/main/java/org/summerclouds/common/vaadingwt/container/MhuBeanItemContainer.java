...
import org.summerclouds.common.vaadingwt.ColumnModel;
import org.summerclouds.common.vaadingwt.MhuTable;
...
public class MhuBeanItemContainer<BEANTYPE> extends MhuAbstractBeanContainer<BEANTYPE, BEANTYPE> {
    ...
    public static Align mapToVaadin(org.summerclouds.common.vaadingwt.annotation.Align align) {
        switch (align) {
            case CENTER:
                return Align.CENTER;
            case LEFT:
