...
public class ExpandingTable extends Table {
    ...
    private EventHandler<RenderListener> renderEventHandler =
            new EventHandler<RenderListener>() {
    ...
    private EventHandler<SortListener> sortEventHandler =
            new EventHandler<SortListener>() {
    ...
    public EventHandler<RenderListener> renderEventHandler() {
        return renderEventHandler;
    }

    public EventHandler<SortListener> sortEventHandler() {
